...
style main_menu_frame:
    background Frame("gui/main_menu_frame.png", 1, 1)
...
screen main_menu():
    ...
    add "main_menu background_image"
    add "main_menu cryptaloo_text"
...
style act_menu_frame is main_menu_frame

screen act_menu():
    # This ensures that any other menu screen is replaced
    tag menu

    add "act_menu_background"
        ...
        frame:
            ...
            fixed:
                ...
                if act_2_completed == True:
                    image "closure_checkbox_tick2.png"
